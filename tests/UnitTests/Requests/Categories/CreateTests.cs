...
public class CreateTests
{
    ...
    [Fact]
    public void CreateRequest_ShouldHaveDefaultValues()
    {
        // Arrange
    ...
    [Fact]
    public void CreateRequest_ShouldBeValidWithValidData()
    {
        // Arrange
        var request = new Create
        {
    ...
    [Fact]
    public void CreateRequest_ShouldFailValidation_WhenTitleIsMissing()
    {
        // Arrange
        var request = new Create
        {
    ...
    [Fact]
    public void CreateRequest_ShouldFailValidation_WhenTitleIsTooLong()
    {
        // Arrange
        var request = new Create
        {
    ...
    [Fact]
    public void CreateRequest_ShouldFailValidation_WhenDescriptionIsMissing()
    {
        // Arrange
        var request = new Create
        {
